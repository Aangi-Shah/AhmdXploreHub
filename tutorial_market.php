        ...
        <head>
            ...
            <title>Tutorial Market Learn More</title>
        ...
        <a href='home.html'>Logout<br></a>
            ...
            <div class='event-detail-container'>
                <div class='event-header'>
                    <h1 style='color:purple'><center>Tutorial Market</center></h1>
                </div>
                <div class='image'>
                    <img src='tutorial.jpg' alt='Full Image' class='full-image'>
                    <div class='side-images'>
                        <img src='tutorial1.jpg' alt='Side Image 1'>
                        <img src='tutorial2.jpg' alt='Side Image 2'>
                    </div>
                </div>
                <div class='event-description'>
                    <p><strong>Three Gate has a wide range of products and services to cater to the varied requirements of their customers.</strong></p>
                </div>
                <div class='event-details'>
                    <h2>About</h2>
                    <div class='review'>
                        <p>Tutorial Market is one of the oldest and busiest shopping places in Ahmedabad and you simply can't afford to miss this amazing place on your shopping spree in the city. It is one of the most popular shopping places in Ahmedabad.It market is known for traditional wear sarees, bed sheets, gourmet material, handicrafts, footwear, dresses for sofa etc. at very affordable prices.</p>
                    </div>
                </div>
                <div class='event-details'>
                    <h2>Key Features</h2>
                    <div class='review'>
                        <p>Market in Ahmedabad to famous Saree Market, Ahmedabad shopping speciality will amaze you.
SHOPPING
...
Zari work</p>
                ...
                <div class='event-details'>
                    ...
                    <div class='review'>
                        <ul>
                            <li><strong>Address:</strong> Gandhi Rd, Old City, Dhalgarwad, Khadia, Ahmedabad, Gujarat 380001</li>
                            <li><strong>Timings: </strong>11:00 AM - 10:00 PM</li>
                            <li><strong>Phone:</strong> </li>
                        </ul>
                    </div>
                </div>
        <div class='wishlist-booking'>
            <button class='wishlist-btn' onclick='addToWishlist("Tutorial Market", "tutorial.jpg", 33)'>Add to Wishlist</button>
            <form method='post' action='booking.php'> <!-- Update action attribute here -->
                <input type='hidden' name='serviceID' value='33'>
                <button type='submit' class='booking-btn'>Book Now</button>
            </form>
        </div>
    <div class='event-reviews'>
        <!-- Add reviews section here -->
        <h2>Feedbacks</h2><p>Aanya Ahuja: Kankaria Lake: A serene oasis in Ahmedabad, offering picturesque surroundings and diverse recreational activities.</p><p>Emma Monroe: AhmdXploreHub: Simple, informative, and visually appealing for exploring Ahmedabad.</p><p>Aangi Shah: Vintage Vibes has positive and great vibes place, amazing place to visit with friends and family!</p></div>

    <div class='more-events'>
        <h2>More Places</h2>
        
        <div class='event-container'><div class='event'><img src='sciencecity3.jpeg' alt='Science City'><div class='event-details'><h3>Science City</h3><p>Discover, Innovate, Thrive: Science City Ahmedabad, Where Curiosity Meets Creativity.</p><a href='science_city.php' target='_self'><button>Learn More</button></a></div></div><div class='event'><img src='accolade.jpg' alt='Hotel Accolade'><div class='event-details'><h3>Hotel Accolade</h3><p>Enjoy upscale amenities and a brilliant location</p><a href='hotel_accolade.php' target='_self'><button>Learn More</button></a></div></div><div class='event'><img src='unlocked.jpg' alt='Unlocked'><div class='event-details'><h3>Unlocked</h3><p>'Unlocked Cafe' in Ahmedabad is our first space with cozy geometric interiors and a board game cafe.</p><a href='unlocked.php' target='_self'><button>Learn More</button></a></div></div>
        </div>
    </div>
